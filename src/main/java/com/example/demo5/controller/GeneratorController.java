...
//            @ApiParam(required = true, value = "minpts",example = "10", type = "int") @RequestParam(required = false, defaultValue = "10") Integer minpts,
//            @ApiParam(required = true, value = "eps",example = "100", type = "double") @RequestParam(required = false, defaultValue = "100") Double eps,
...
//        }
        ...
        return new ResponseResult(200,"地点生成成功", placeInfo);
